...
import static com.sas.utibox.SwiftDataUtils.*;
import static com.sas.utibox.SwiftMainActivity.*;
...
import static com.sas.utibox.SwiftMainActivity.deleteActive;
import static com.sas.utibox.SwiftMainActivity.searchActive;
import static com.sas.utibox.SwiftMainActivity.setFavourite;


/**
 * Adapter class for custom notes ListView
 */
class SwiftNoteAdapter extends BaseAdapter implements ListAdapter {
     ...
     */
    SwiftNoteAdapter(Context context, JSONArray adapterData) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = this.inflater.inflate(R.layout.swift_list_view_note, parent, false);
