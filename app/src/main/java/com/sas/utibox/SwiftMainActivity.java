...
import static com.sas.utibox.SwiftDataUtils.BACKUP_FILE_NAME;
import static com.sas.utibox.SwiftDataUtils.BACKUP_FOLDER_PATH;
import static com.sas.utibox.SwiftDataUtils.NEW_NOTE_REQUEST;
import static com.sas.utibox.SwiftDataUtils.NOTES_FILE_NAME;
import static com.sas.utibox.SwiftDataUtils.NOTE_BODY;
import static com.sas.utibox.SwiftDataUtils.NOTE_COLOUR;
import static com.sas.utibox.SwiftDataUtils.NOTE_FAVOURED;
import static com.sas.utibox.SwiftDataUtils.NOTE_FONT_SIZE;
import static com.sas.utibox.SwiftDataUtils.NOTE_HIDE_BODY;
import static com.sas.utibox.SwiftDataUtils.NOTE_REQUEST_CODE;
import static com.sas.utibox.SwiftDataUtils.NOTE_TITLE;
import static com.sas.utibox.SwiftDataUtils.deleteNotes;
import static com.sas.utibox.SwiftDataUtils.isExternalStorageReadable;
import static com.sas.utibox.SwiftDataUtils.isExternalStorageWritable;
import static com.sas.utibox.SwiftDataUtils.retrieveData;
import static com.sas.utibox.SwiftDataUtils.saveData;


public class SwiftMainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,
    ...
    private static SwiftNoteAdapter adapter; // Custom ListView notes adapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SwiftNoteAdapter(getApplicationContext(), notes);
        ...
        newNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SwiftMainActivity.this, SwiftEditActivity.class);
    ...
    protected void initToolbar() {
        ...
        toolbar.inflateMenu(R.menu.swift_menu_main);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this, SwiftEditActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        mode.getMenuInflater().inflate(R.menu.swift_menu_delete, menu); // Inflate 'menu_delete' menu
    ...
    public boolean onQueryTextChange(String s) {
        ...
        if (s.length() > 0) {
            ...
            SwiftNoteAdapter searchAdapter = new SwiftNoteAdapter(getApplicationContext(), notesFound);
        ...
        if (newFavourite != null) {
            if (favourite) {
                ...
                if (position > 0) {
                    ...
                    notes = newArray;
                    adapter = new SwiftNoteAdapter(context, notes);
                    listView.setAdapter(adapter);
