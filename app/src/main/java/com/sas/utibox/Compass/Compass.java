...
public class Compass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMag.setTextColor(Color.BLACK);
        ...
        eListener = new CompassMySensorEventListener(sensorManager, imgCompass, tvDegree, tvMag);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.action_settings:
                Intent intent = new Intent(this, CompassSettings.class);
    ...
    private void calibrateDialog(){
        ...
        View calibrateView = layoutInflater.inflate(R.layout.compass_calibrate_dialog_layout, null);
