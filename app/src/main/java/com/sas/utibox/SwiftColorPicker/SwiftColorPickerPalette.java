 ...
 */
public class SwiftColorPickerPalette extends TableLayout {
    ...
    public SwiftColorPickerPalette(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SwiftColorPickerPalette(Context context) {
        super(context);
    }
    ...
    public void init(int size, int columns, OnColorSelectedListener listener) {
        ...
        if (size == SwiftColorPickerDialog.SIZE_LARGE) {
     ...
     */
    private SwiftColorPickerSwatch createColorSwatch(int color, int selectedColor) {
        SwiftColorPickerSwatch view = new SwiftColorPickerSwatch(getContext(), color,
