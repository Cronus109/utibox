package com.sas.utibox.SwiftColorPicker;
...
import static com.sas.utibox.SwiftColorPicker.SwiftColorPickerSwatch.*;

/**
 * A dialog which takes in as input an array of colors and creates a palette allowing the user to
 * select a specific color swatch, which invokes a listener
 */
public class SwiftColorPickerDialog extends DialogFragment implements OnColorSelectedListener {
    ...
    protected int mTitleResId = R.string.action_note_colour;
    ...
    private SwiftColorPickerPalette mPalette;
    private ProgressBar mProgress;

    protected OnColorSelectedListener mListener;

    public SwiftColorPickerDialog() {
        // Empty constructor required for dialog fragments
    }

    public static SwiftColorPickerDialog newInstance(int titleResId, int[] colors, int selectedColor,
                                                int columns, int size) {

        SwiftColorPickerDialog ret = new SwiftColorPickerDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.swift_color_picker_dialog, null);
        mProgress = (ProgressBar) view.findViewById(android.R.id.progress);
        mPalette = (SwiftColorPickerPalette) view.findViewById(R.id.color_picker);
