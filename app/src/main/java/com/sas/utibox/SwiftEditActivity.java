...
import com.sas.utibox.SwiftColorPicker.SwiftColorPickerDialog;

import static com.sas.utibox.SwiftColorPicker.SwiftColorPickerSwatch.OnColorSelectedListener;
import static com.sas.utibox.SwiftColorPicker.SwiftColorPickerSwatch.OnTouchListener;
...
public class SwiftEditActivity extends AppCompatActivity implements Toolbar.OnMenuItemClickListener {
    ...
    private SwiftColorPickerDialog colorPickerDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.swift_activity_edit);
    ...
    protected void initToolbar() {
        ...
        toolbar.inflateMenu(R.menu.swift_menu_edit);
    ...
    protected void initDialogs(Context context) {
        ...
        colorPickerDialog = SwiftColorPickerDialog.newInstance(R.string.dialog_note_colour,
                colourArrResId, Color.parseColor(colour), 3,
                isTablet(this) ? SwiftColorPickerDialog.SIZE_LARGE : SwiftColorPickerDialog.SIZE_SMALL);
